...
void draw() {
  ...
  //filler mit objekt med farven sort
  fill(0);
  // Her tegner jeg min firkant som skal dække skærmen med min gesture
  float cutSize = cut * width / 2;
